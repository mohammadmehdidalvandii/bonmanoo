  ...
  return (
    <section className={style.info}>
        <div className={style.info_wrapper}>
            <h6 className={style.info_subtitle}>COLOMBIA HUILA COFFEE BEANS</h6>
            <div className={style.info_title_score}>
                <h4 className={style.info_title}>دانه قهوه تک‌خاستگاه کلمبیا هویلا</h4>
            ...
            <div className={style.info_category_sku}>
                <div className={style.info_category_wrapper}>
                    ...
                    <Link href="#" className={style.info_category_text}>تک خواستگاه</Link>
                </div>
